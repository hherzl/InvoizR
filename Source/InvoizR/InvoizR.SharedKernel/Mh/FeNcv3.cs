...
public partial class FeNcv3 : Dte
{
    ...
    public System.Collections.Generic.ICollection<DocumentoRelacionado> DocumentoRelacionado { get; set; } = new System.Collections.ObjectModel.Collection<DocumentoRelacionado>();
...
public partial class Identificacion : object
{
    ...
    [System.ComponentModel.DataAnnotations.RegularExpression(@"^DTE-05-[A-Z0-9]{8}-[0-9]{15}$")]
