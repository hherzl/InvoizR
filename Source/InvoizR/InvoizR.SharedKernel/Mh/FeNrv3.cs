...
public partial class Identificacion : object
{
    ...
    [System.ComponentModel.DataAnnotations.RegularExpression(@"^DTE-04-[A-Z0-9]{8}-[0-9]{15}$")]
...
public partial class Receptor : object
{
    ...
    [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
    //[System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Serialization.JsonStringEnumConverter))]
    //public ReceptorTipoDocumento TipoDocumento { get; set; }
    ...
    /// <summary>
    /// Bienes Remitidos a Título de
    /// </summary>

    [System.Text.Json.Serialization.JsonPropertyName("bienTitulo")]
