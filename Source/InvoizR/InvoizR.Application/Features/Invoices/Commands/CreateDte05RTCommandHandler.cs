...
public sealed class CreateDte05RTCommandHandler(ILogger<CreateDte05RTCommandHandler> logger, IServiceProvider serviceProvider)
    : IRequestHandler<CreateDte05RTCommand, CreatedResponse<long?>>
{
    public async Task<CreatedResponse<long?>> Handle(CreateDte05RTCommand request, CancellationToken ct)
    {
