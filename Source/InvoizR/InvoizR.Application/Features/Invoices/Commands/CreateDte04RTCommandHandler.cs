...
public sealed class CreateDte04RTCommandHandler(ILogger<CreateDte04RTCommandHandler> logger, IServiceProvider serviceProvider)
    : IRequestHandler<CreateDte04RTCommand, CreatedResponse<long?>>
{
    public async Task<CreatedResponse<long?>> Handle(CreateDte04RTCommand request, CancellationToken ct)
    {
