...
if (clientArgs.Mock)
{
    ...
    {
        var req = InvoiceMocker.MockDte01();

        Console.WriteLine($" Syncing invoice '{req.InvoiceNumber}', {req.InvoiceTotal:C2}...");

        try
        {
            var response = await client.CreateDte01InvoiceAsync(req);
...
class InvoiceMocker
{
    public static CreateDte01InvoiceCommand MockDte01()
    {
        var data = new
        {
        ...
        var req = new CreateDte01InvoiceCommand
        {
