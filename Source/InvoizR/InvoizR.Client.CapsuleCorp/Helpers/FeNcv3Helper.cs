...
public static class FeNcv3Helper
{
    public static FeNcv3 Create(CreateDte05Command request, IEnumerable<InvoiceLine> lines)
    {
        var dte = new FeNcv3();

        dte.Identificacion.Version = FeNcv3.Version;
        dte.Identificacion.Ambiente = MhCatalog.Cat001.Prueba;
        dte.Identificacion.TipoDte = FeNcv3.SchemaType;
