...
internal class FeNrv3Helper
{
    public static FeNrv3 Create(CreateDte04Command request, List<InvoiceLine> lines)
    {
        var dte = new FeNrv3();

        dte.Identificacion.Version = FeNrv3.Version;
        dte.Identificacion.Ambiente = MhCatalog.Cat001.Prueba;
        dte.Identificacion.TipoDte = FeNrv3.SchemaType;
