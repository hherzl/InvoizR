...
internal class ThirdPartyServiceConfiguration : AuditableEntityConfiguration<ThirdPartyService>
{
    public override void Configure(EntityTypeBuilder<ThirdPartyService> builder)
    {
