...
internal class FallbackConfiguration : AuditableEntityConfiguration<Fallback>
{
    public override void Configure(EntityTypeBuilder<Fallback> builder)
    {
        ...
        builder.Property(p => p.CompanyId).HasColumnType("smallint");
        builder.Property(p => p.Name).HasColumnType("nvarchar").HasMaxLength(100).IsRequired();
        builder.Property(p => p.StartDateTime).HasColumnType("datetime").IsRequired();
        builder.Property(p => p.EndDateTime).HasColumnType("datetime");
        builder.Property(p => p.Enable).HasColumnType("bit").IsRequired();
        builder.Property(p => p.FallbackGuid).HasColumnType("nvarchar").HasMaxLength(50);
        ...
        builder.Property(p => p.RetryIn).HasColumnType("int").IsRequired();
        builder.Property(p => p.SyncAttempts).HasColumnType("int").IsRequired();
